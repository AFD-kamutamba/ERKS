...
public class StockAdapter extends BaseAdapter {
    ...
    public StockAdapter(Context context, ArrayList<StockItem> objects, int i) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            holder.imageViewPicture = (ImageView) convertView.findViewById(R.id.picture_item_stock);
